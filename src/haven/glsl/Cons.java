...
public class Cons {
    ...
    public static Expression sin(Expression x) {
        return (Function.Builtin.sin.call(x));
    }
    ...
    public static Expression smoothstep(Expression a, Expression b, Expression x) {
        return (Function.Builtin.smoothstep.call(a, b, x));
    }
    ...
    public static Expression col4(java.awt.Color c) {
        return (vec4(l(c.getRed() / 255.0), l(c.getGreen() / 255.0), l(c.getBlue() / 255.0), l(c.getAlpha() / 255.0)));
    }

    public static Expression col3(java.awt.Color c) {
        return (vec3(l(c.getRed() / 255.0), l(c.getGreen() / 255.0), l(c.getBlue() / 255.0)));
    }

    public static Expression vec2(haven.Coord c) {
        return (vec2(l((double) c.x), l((double) c.y)));
    }

    public static Expression vec3(haven.Coord3f c) {
        return (vec3(l(c.x), l(c.y), l(c.z)));
    }
